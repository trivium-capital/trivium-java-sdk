...
public class CashApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void putApiV1CashCallback(CashInboundCallbackEvent cashInboundCallbackEvent, String xDeduplicationId) throws ApiException {
    this.putApiV1CashCallback(cashInboundCallbackEvent, xDeduplicationId, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void putApiV1CashCallback(CashInboundCallbackEvent cashInboundCallbackEvent, String xDeduplicationId, Map<String, String> additionalHeaders) throws ApiException {
