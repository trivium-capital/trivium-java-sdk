...
public class CashApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Rates getApiV1CashRates() throws ApiException {
    return this.getApiV1CashRates(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public Rates getApiV1CashRates(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void postApiV1CashRequestDepositAccountid(UUID accountId, DepositRequest depositRequest) throws ApiException {
    this.postApiV1CashRequestDepositAccountid(accountId, depositRequest, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void postApiV1CashRequestDepositAccountid(UUID accountId, DepositRequest depositRequest, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void postApiV1CashRequestRedemptionAccountid(UUID accountId, RedemptionRequest redemptionRequest) throws ApiException {
    this.postApiV1CashRequestRedemptionAccountid(accountId, redemptionRequest, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void postApiV1CashRequestRedemptionAccountid(UUID accountId, RedemptionRequest redemptionRequest, Map<String, String> additionalHeaders) throws ApiException {
