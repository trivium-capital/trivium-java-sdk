...
public class TransactionsApi extends BaseApi {
   ...
   */
  public PaginationResultUserTransaction getApiV1TransactionsUserid(UUID userId, Integer limit, Integer offset) throws ApiException {
    return this.getApiV1TransactionsUserid(userId, limit, offset, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public PaginationResultUserTransaction getApiV1TransactionsUserid(UUID userId, Integer limit, Integer offset, Map<String, String> additionalHeaders) throws ApiException {
