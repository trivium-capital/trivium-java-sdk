...
public class CompanyDetails implements UserDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taxId, companyName, email, fullName, preferredName, type);
  }
