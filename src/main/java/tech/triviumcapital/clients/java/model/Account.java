...
public class Account {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountType, currencyCode, status, provider, earningsToDate, balance, depositInstructions);
  }
